...
bool SimpleGUI::Button::OnMouseUp(MouseKeys mb, int innerX, int innerY)
{
...
void SimpleGUI::Button::SetClickHandler(std::function <void(MouseKeys mb, int innerX, int innerY)> _handler)
{
