...
ShiftEngine::Renderer::Renderer(D3D10ShaderManager * _pShaderManager, D3D10ShaderGenerator * _pShaderGenerator)
	...
	millisecondsPerFrame(0), pShaderManager(_pShaderManager), 
...
void ShiftEngine::Renderer::drawSky( RenderQueue &rq )
{
	...
	if(skyNode)
	{
		...
		skyNode->SetPosition(Vector3F(pos.x, pos.y, pos.z));
		skyNode->SetScale(Vector3F(10.0f, 10.0f, 10.0f));
