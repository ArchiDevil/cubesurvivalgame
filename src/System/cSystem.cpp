...
cSystem::cSystem()
	: WindowHandler(0), WindowInstance(0), State(AS_Running)
{
	System = this;
}
...
bool cSystem::InitializeWindow( HINSTANCE hInstance, int Width, int Height, LPCWSTR AppName )
{
	...
	this->WindowHandler = ::CreateWindow(
		...
		WS_OVERLAPPEDWINDOW,	//стиль создаваемого окна
